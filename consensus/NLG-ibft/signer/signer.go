...
// Signer is responsible for signing for blocks and messages in NLG-IBFT
...
// GetIBFTExtra extracts NLG-IBFT Extra from the given header
...
// WriteProposerSeal signs and set ProposerSeal into NLG-IBFT Extra of the header
...
func (s *SignerImpl) CreateCommittedSeal(hash []byte) ([]byte, error) {
	return s.keyManager.SignCommittedSeal(
		// Of course, this keccaking of an extended array is not according to the NLG-IBFT 2.0 spec,
...
// WriteCommittedSeals builds and writes CommittedSeals into NLG-IBFT Extra of the header
...
// VerifyCommittedSeals verifies CommittedSeals in NLG-IBFT Extra of the header
...
// VerifyParentCommittedSeals verifies ParentCommittedSeals in NLG-IBFT Extra of the header
...
// CalculateHeaderHash calculates header hash for NLG-IBFT Extra
...
// GetParentCommittedSeals extracts Parent Committed Seals from NLG-IBFT Extra in Header
...
// filterHeaderForHash removes unnecessary fields from NLG-IBFT Extra of the header
...
func (s *SignerImpl) FilterHeaderForHash(header *types.Header) (*types.Header, error) {
	...
	// This will effectively remove the Seal and CommittedSeals from the NLG-IBFT Extra of header,

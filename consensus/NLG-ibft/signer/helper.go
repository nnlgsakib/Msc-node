...
import (
	...
	"github.com/Mind-chain/mind/secrets/helper"
...
// calculateHeaderHash is hash calculation of header for NLG-IBFT
...
// verifyIBFTExtraSize checks whether header.ExtraData has enough size for NLG-IBFT Extra

...
// DISCLAIMER: NLG-IBFT will be deprecated so we set 1 as a voting power to all validators
...
func (i *backendIBFT) buildBlock(parent *types.Header) (*types.Block, error) {
	...
	// (for the NLG-IBFT consensus, it is correct to have just a header, as only it is used)

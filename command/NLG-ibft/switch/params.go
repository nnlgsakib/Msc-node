...
var (
	...
	ErrIBFTConfigNotFound            = errors.New(`"nibft" config doesn't exist in "engine" of genesis.json'`)
	ErrSameIBFTAndValidatorType      = errors.New("cannot specify same NLG-IBFT type and validator type as the last fork")

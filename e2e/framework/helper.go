...
import (
	...
	"github.com/Mind-chain/mind/contracts/abis"
	...
	txpoolProto "github.com/Mind-chain/mind/txpool/proto"
...
func NewTestServers(t *testing.T, num int, conf func(*TestServerConfig)) []*TestServer {
	...
	// is called for the Dev consensus mode, and NLG-IBFT servers are initialized with NewIBFTServersManager.
